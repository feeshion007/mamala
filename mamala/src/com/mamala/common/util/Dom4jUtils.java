...
/**
 ****    Dom4jUtil
 ****    Dom4jUtil class build 04/28 10:00
 ****    CopyRight  Xiaoyuer
 ****    Author : ChenXiaoyuer
 ****    Email  : windflowers1976@msn.com
 ****    命令格式:
 ****    运行范例:
 ****    修改日志: 2008-09-01 移植到JDK1.5下消除部分编译WARNING。
 */
...
public abstract class Dom4jUtils {
    ...
    /**
     *  
     * <p>Description:  验证文档格式是否正确           </p>
     * <p>Create Time: 2012-1-18   </p>
     * @author quenaizhen
     * @param document 配置文档
     * @throws SAXException document校验异常
     * @throws ParserConfigurationException XML
     */
...
//        // 读取mib-mapping验证文件
//        EntityResolver resolver = new RuijieEntityResolver(Dom4jUtils.class.getClassLoader());
//
//        // 创建默认的XML错误处理器
//        XMLErrorHandler errorHandler = new XMLErrorHandler();
//
